...
int main() {
     //output to console - coding is cool
...
int main() {
    ...
    double mysteryDataType = 5.6f; //Use Google to work this out
...
int main() {
    ...
    int numberOne = 8;
    int numberTwo = 10;
    //int variable declared  that adds two other int varibles
    int numSum = numberOne + numberTwo;
    //printing the added variables to console
    cout << numSum << endl;
