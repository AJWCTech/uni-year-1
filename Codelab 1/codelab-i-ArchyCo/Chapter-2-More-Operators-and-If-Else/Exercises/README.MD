...
START
  ...
  IF money >= 25
    ...
    ELSE
      CALCULATE money need for the purchase
...
### Bonus Exercise (Optional): Chessboard Checker
...
``` C++
#include <iostream> // preprocessor directive - include iostream file
#include<cctype>// preprocessor directive - include cctype libary
#include<string.h>// preprocessor directive - include string.h libary
using namespace std; // declare use of the standard namespace
...
### J: Mark my Words :ballot_box_with_check:
