...
### Bonus Exercise 1 (Optional): Iterating through arrays
...
### Bonus Exercise 2 (Optional): Address Storage

Use a multidimensional string array that will store the names and respective postcodes of 3 or more people. Once you have declared the array have the user enter the required data then print out the details of each person to the console, e.g.
