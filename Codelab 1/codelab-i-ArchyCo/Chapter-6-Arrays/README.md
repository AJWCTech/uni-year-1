...
An array is a container object that holds a fixed number of values of a single type. While a variable stores one value only, an array stores a series of values.
